...
- (WKWebViewConfiguration *)setUpWkWebViewConfig
{
  ...
  [wkWebViewConfig.userContentController addScriptMessageHandler:[[RNCWeakScriptMessageDelegate alloc] initWithDelegate:self]
    ...
    /////客户化应对支付
    [wkWebViewConfig.userContentController addScriptMessageHandler:self name:@"openOutSideUrl"];
    [wkWebViewConfig.userContentController addScriptMessageHandler:self name:@"depositFinish"];
    [wkWebViewConfig.userContentController addScriptMessageHandler:self name:@"nativePay"];
    //////////
...
- (void)removeFromSuperview
{
    if (_webView) {
        ...
        /////去掉客户化的事件注册
        [_webView.configuration.userContentController removeScriptMessageHandlerForName:@"openOutSideUrl"];
        [_webView.configuration.userContentController removeScriptMessageHandlerForName:@"depositFinish"];
        [_webView.configuration.userContentController removeScriptMessageHandlerForName:@"nativePay"];
        /////
       ...
       didReceiveScriptMessage:(WKScriptMessage *)message
{
  ...
  } else if ([message.name isEqualToString:@"openOutSideUrl"] || [message.name isEqualToString:@"depositFinish"] || [message.name isEqualToString:@"nativePay"]) {
      if (_onMessage) {
        NSMutableDictionary<NSString *, id> *event = [self baseEvent];
        [event addEntriesFromDictionary: @{@"data": message.body}];
        [event addEntriesFromDictionary: @{@"name": message.name}];////客户化添加
        _onMessage(event);
      }
    }
}
...
- (void)resetupScripts:(WKWebViewConfiguration *)wkWebViewConfig {
  ...
  [wkWebViewConfig.userContentController removeScriptMessageHandlerForName:MessageHandlerName];
    /////去掉客户化的事件注册
    [wkWebViewConfig.userContentController removeScriptMessageHandlerForName:@"openOutSideUrl"];
    [wkWebViewConfig.userContentController removeScriptMessageHandlerForName:@"depositFinish"];
    [wkWebViewConfig.userContentController removeScriptMessageHandlerForName:@"nativePay"];
    /////
  if(self.enableApplePay){
